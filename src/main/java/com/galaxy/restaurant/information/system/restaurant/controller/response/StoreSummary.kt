...
data class StoreSummary(
    ...
    val id: Long,
    @field:Schema(description = "가게 이름", example = "맛집")
    val name: String,
    @field:Schema(description = "이미지", example = "https://picsum.photos/1600/900")
    val image: String,
    @field:Schema(description = "위치", example = "서울시 강남구")
    val location: String,
    @field:Schema(description = "음식 종류", example = "KOREAN")
    val type: RestaurantType,
    @field:Schema(description = "영업시간", example = "10:00 ~ 20:00")
    val businessHour: String,
    @field:Schema(description = "가게 설명", example = "맛있는 음식점")
